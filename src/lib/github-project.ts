...
/** Ship BETA.md with ejected apps so the philosophy travels with the code. */
function loadBetaMdForShip(): string {
  try {
    return readFileSync(join(process.cwd(), "BETA.md"), "utf8");
  } catch {
    return `# Welcome to Shipboard Beta

This app was generated by [Shipboard](https://shipboard.ca).

See the platform repository or https://shipboard.ca for the full beta onboarding path, CLI sync, and architecture overview.
`;
  }
}
