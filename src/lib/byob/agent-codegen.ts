...
export function generateAgentChatRouteTs(opts?: {
  ...
  if (telemetry) {
    imports.push(`import { wrapToolsWithTracing } from "@/lib/agent/telemetry";`);
  }
 ...
 *
 * Generated by Shipboard Phase C/D (Tool Bus + Telemetry).
 */
${imports.join("\n")}
...
export { withTracing, wrapToolsWithTracing } from "./telemetry";
`;
}
